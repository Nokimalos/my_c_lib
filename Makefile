...
tests_run: $(OBJ_CTYPE) $(OBJ_MATH) $(OBJ_STDIO) $(OBJ_STRING) $(OBJ_TEST)
	$(CC) -o $(TESTNAME) $(SRC_CTYPE) $(SRC_MATH) $(SRC_STDIO) $(SRC_STRING) $(SRC_TEST) $(CPPFLAGS) $(CFLAGS) $(TFLAGS)
	-./$(TESTNAME) && $(HTMLFLAGS)

cleanobjs:
	$(RM) *.o $(RM) src/*.o $(RM) src/ctype/*.o $(RM) src/math/*.o $(RM) src/string/*.o $(RM) src/stdio/my_printf/*.o $(RM) tests/*.o
