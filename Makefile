...
SRC		=	src/my_put_nbr.c			\
			...
			src/stdio/my_printf/my_bflag.c		\
			src/stdio/my_printf/my_xflag.c		\
			src/stdio/my_printf/my_higher_xflag.c	\
			src/stdio/my_printf/my_oflag.c		\
			src/stdio/my_printf/my_pflag.c		\
			src/stdio/my_printf/my_printf.c		\
			src/stdio/my_printf/my_uflag.c		\
			src/stdio/my_printf/utils.c
